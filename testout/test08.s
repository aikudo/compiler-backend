...
BB0__main:                                                          
      ...
      st    %l4, [%fp-15]             ! _c3.1                  
if12005:                                                          
      cmp   %l0, %l1                  ! l(53): jne _i1.1 _i2.1 el12005
      bne   BB1__main                 ! BB1__main -> el12005   
      nop                                                      
      smul  %l2, 10, %l0              ! l(56): mul _i3.1 10 t8 
      add   %l0, 1, %l1               ! l(58): add t8 1 t9DEF  
      mov   %l1, %l0                  ! t9 -> _i3.1            
      st    %l0, [%fp-12]             ! _i3.1                  
      ba    BB2__main                 ! l(60): jmp fi12005     
      nop                             ! BB2__main -> fi12005   
BB1__main:                                                          
...
BB2__main:                                                          
if13005:                                                          
      cmp   %l0, %l2                  ! l(68): jeq _i1.1 _i2.1 el13005
      be    BB3__main                 ! BB3__main -> el13005   
      nop                                                      
      smul  %l0, 10, %l1              ! l(71): mul _i3.1 10 t15
      add   %l1, 1, %l0               ! l(73): add t15 1 t16DEF
      mov   %l0, %l1                  ! t16 -> _i3.1           
      st    %l1, [%fp-12]             ! _i3.1                  
      ba    BB4__main                 ! l(75): jmp fi13005     
      nop                             ! BB4__main -> fi13005   
BB3__main:                                                          
...
BB4__main:                                                          
if14005:                                                          
      cmp   %l0, %l2                  ! l(83): jge _i1.1 _i2.1 el14005
      bge   BB5__main                 ! BB5__main -> el14005   
      nop                                                      
      smul  %l0, 10, %l1              ! l(86): mul _i3.1 10 t22
      add   %l1, 1, %l0               ! l(88): add t22 1 t23DEF
      mov   %l0, %l1                  ! t23 -> _i3.1           
      st    %l1, [%fp-12]             ! _i3.1                  
      ba    BB6__main                 ! l(90): jmp fi14005     
      nop                             ! BB6__main -> fi14005   
BB5__main:                                                          
...
BB6__main:                                                          
if15005:                                                          
      cmp   %l0, %l2                  ! l(98): jlt _i1.1 _i2.1 el15005
      bl    BB7__main                 ! BB7__main -> el15005   
      nop                                                      
      smul  %l0, 10, %l1              ! l(101): mul _i3.1 10 t29
      add   %l1, 1, %l0               ! l(103): add t29 1 t30DEF
      mov   %l0, %l1                  ! t30 -> _i3.1           
      st    %l1, [%fp-12]             ! _i3.1                  
      ba    BB8__main                 ! l(105): jmp fi15005    
      nop                             ! BB8__main -> fi15005   
BB7__main:                                                          
...
BB8__main:                                                          
if16005:                                                          
      cmp   %l0, %l2                  ! l(113): jle _i1.1 _i2.1 el16005
      ble   BB9__main                 ! BB9__main -> el16005   
      nop                                                      
      smul  %l0, 10, %l1              ! l(116): mul _i3.1 10 t36
      add   %l1, 1, %l0               ! l(118): add t36 1 t37DEF
      mov   %l0, %l1                  ! t37 -> _i3.1           
      st    %l1, [%fp-12]             ! _i3.1                  
      ba    BB10__main                ! l(120): jmp fi16005    
      nop                             ! BB10__main -> fi16005  
BB9__main:                                                          
...
BB10__main:                                                          
if17005:                                                          
      cmp   %l0, %l2                  ! l(128): jgt _i1.1 _i2.1 el17005
      bg    BB11__main                ! BB11__main -> el17005  
      nop                                                      
      smul  %l0, 10, %l1              ! l(131): mul _i3.1 10 t43
      add   %l1, 1, %l0               ! l(133): add t43 1 t44DEF
      mov   %l0, %l1                  ! t44 -> _i3.1           
      st    %l1, [%fp-12]             ! _i3.1                  
      ba    BB12__main                ! l(135): jmp fi17005    
      nop                             ! BB12__main -> fi17005  
BB11__main:                                                          
...
BB12__main:                                                          
      ...
      st    %l0, [%fp-12]             ! _i3.1                  
if22005:                                                          
      cmp   %l1, %l2                  ! l(150): jne _c1.1 _c2.1 el22005
      bne   BB13__main                ! BB13__main -> el22005  
      nop                                                      
      ...
      mov   %l2, %l0                  ! t55 -> _i3.1           
      st    %l0, [%fp-12]             ! _i3.1                  
      ba    BB14__main                ! l(159): jmp fi22005    
      nop                             ! BB14__main -> fi22005  
BB13__main:                                                          
...
BB14__main:                                                          
if23005:                                                          
      cmp   %l1, %l2                  ! l(169): jeq _c1.1 _c2.1 el23005
      be    BB15__main                ! BB15__main -> el23005  
      nop                                                      
      ...
      mov   %l2, %l0                  ! t64 -> _i3.1           
      st    %l0, [%fp-12]             ! _i3.1                  
      ba    BB16__main                ! l(178): jmp fi23005    
      nop                             ! BB16__main -> fi23005  
BB15__main:                                                          
...
BB16__main:                                                          
if24005:                                                          
      cmp   %l1, %l2                  ! l(188): jge _c1.1 _c2.1 el24005
      bge   BB17__main                ! BB17__main -> el24005  
      nop                                                      
      ...
      mov   %l2, %l0                  ! t73 -> _i3.1           
      st    %l0, [%fp-12]             ! _i3.1                  
      ba    BB18__main                ! l(197): jmp fi24005    
      nop                             ! BB18__main -> fi24005  
BB17__main:                                                          
...
BB18__main:                                                          
if25005:                                                          
      cmp   %l1, %l2                  ! l(207): jlt _c1.1 _c2.1 el25005
      bl    BB19__main                ! BB19__main -> el25005  
      nop                                                      
      ...
      mov   %l2, %l0                  ! t82 -> _i3.1           
      st    %l0, [%fp-12]             ! _i3.1                  
      ba    BB20__main                ! l(216): jmp fi25005    
      nop                             ! BB20__main -> fi25005  
BB19__main:                                                          
...
BB20__main:                                                          
if26005:                                                          
      cmp   %l1, %l2                  ! l(226): jle _c1.1 _c2.1 el26005
      ble   BB21__main                ! BB21__main -> el26005  
      nop                                                      
      ...
      mov   %l2, %l0                  ! t91 -> _i3.1           
      st    %l0, [%fp-12]             ! _i3.1                  
      ba    BB22__main                ! l(235): jmp fi26005    
      nop                             ! BB22__main -> fi26005  
BB21__main:                                                          
...
BB22__main:                                                          
if27005:                                                          
      cmp   %l1, %l2                  ! l(245): jgt _c1.1 _c2.1 el27005
      bg    BB23__main                ! BB23__main -> el27005  
      nop                                                      
      ...
      st    %l0, [%fp-12]             ! _i3.1                  
      ba    BB24__main                ! l(254): jmp fi27005    
      nop                             ! BB24__main -> fi27005  
BB23__main:                                                          
